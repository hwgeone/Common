...
namespace Infrastructure.Dapper.Extensions.Sql
{
    public interface ISqlGenerator
    {
        DapperExtensionsConfiguration Configuration { get; }
    ...
    {
        public SqlGeneratorImpl(DapperExtensionsConfiguration configuration)
        {
            Configuration = configuration;
        }

        public DapperExtensionsConfiguration Configuration { get; private set; }
