...
namespace Infrastructure.HttpHelper
{
    public class HttpHelper
    {
        ...
        public HttpHelper(string ipaddress = "")
        {
            ...
            _httpClient = new HttpClient (hch){ BaseAddress = new Uri(_baseIPAddress) };
            //帮HttpClient热身
            //_httpClient.SendAsync(new HttpRequestMessage
            //{
            //    Method = new HttpMethod("HEAD"),
            //    RequestUri = new Uri(_baseIPAddress + "/")
        ...
        public T Get<T>(Dictionary<string, string> parameters, string requestUri) where T : class
        {
            ...
            return JsonUtils.Instance.Deserialize<T>(jsonString);
        }
        ...
        public string Post(object entity, string requestUri)
        {
            ...
            if (entity != null)
                request = JsonUtils.Instance.Serialize(entity);
        ...
        public string PostDicObj(Dictionary<string, object> para, string requestUri)
        {
            ...
            foreach (var item in para)
            {
                if (item.Value != null)
                {
                    ...
                    {
                        temp.Add(item.Key, JsonUtils.Instance.Serialize(item.Value));
                    }
                    else
                    {
